...
* Persistent Volume Claims with the format "pvc://{$pvcname}/[path]".
    * The `pvcname` is the name of Persistent Volume Claims that storages models.
    * The `[path]` is the relative path on the Persistent Volume Claims.
