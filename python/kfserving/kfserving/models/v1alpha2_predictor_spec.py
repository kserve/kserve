...
class V1alpha2PredictorSpec(object):
    ...
    def __init__(self, custom=None, logger=None, max_replicas=None, min_replicas=None, onnx=None, parallelism=None, pytorch=None, service_account_name=None, sklearn=None, tensorflow=None, triton=None, xgboost=None):  # noqa: E501
