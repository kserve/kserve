...
from .models.v1alpha2_kf_service import V1alpha2InferenceService
from .models.v1alpha2_kf_service_list import V1alpha2InferenceServiceList
from .models.v1alpha2_kf_service_spec import V1alpha2InferenceServiceSpec
from .models.v1alpha2_kf_service_status import V1alpha2InferenceServiceStatus
