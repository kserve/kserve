...
import kfserving
from kfserving.models.v1beta1_inference_service import V1beta1InferenceService  # noqa: E501
...
class TestV1beta1InferenceService(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfserving.models.v1beta1_inference_service.V1beta1InferenceService()  # noqa: E501
        if include_optional :
            return V1beta1InferenceService(
                api_version = '0', 
                kind = '0', 
                metadata = None, 
                spec = kfserving.models.v1beta1_inference_service_spec.V1beta1InferenceServiceSpec(
                    ...
                    transformer = kfserving.models.v1beta1_transformer_spec.V1beta1TransformerSpec(
                        ...
                        termination_grace_period_seconds = 56, 
                        timeout = 56, ), ), 
                status = kfserving.models.v1beta1_inference_service_status.V1beta1InferenceServiceStatus(
                    address = None, 
                    components = {
