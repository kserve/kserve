...
import kfserving
from kfserving.models.v1beta1_inference_services_config import V1beta1InferenceServicesConfig  # noqa: E501
...
class TestV1beta1InferenceServicesConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfserving.models.v1beta1_inference_services_config.V1beta1InferenceServicesConfig()  # noqa: E501
        if include_optional :
            return V1beta1InferenceServicesConfig(
                explainers = kfserving.models.v1beta1_explainers_config.V1beta1ExplainersConfig(
                    aix = kfserving.models.v1beta1_explainer_config.V1beta1ExplainerConfig(
                        default_image_version = '0', 
                        image = '0', ), 
                    alibi = kfserving.models.v1beta1_explainer_config.V1beta1ExplainerConfig(
                        default_image_version = '0', 
                        image = '0', ), ), 
                predictors = kfserving.models.v1beta1_predictors_config.V1beta1PredictorsConfig(
                    ...
                    xgboost = kfserving.models.v1beta1_predictor_config.V1beta1PredictorConfig(
                        ...
                        default_image_version = '0', 
                        image = '0', ), ), 
                transformers = kfserving.models.v1beta1_transformers_config.V1beta1TransformersConfig(
                    feast = kfserving.models.v1beta1_transformer_config.V1beta1TransformerConfig(
                        default_image_version = '0', 
                        image = '0', ), )
            )
        else :
