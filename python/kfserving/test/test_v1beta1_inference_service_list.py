...
import kfserving
from kfserving.models.v1beta1_inference_service_list import V1beta1InferenceServiceList  # noqa: E501
...
class TestV1beta1InferenceServiceList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfserving.models.v1beta1_inference_service_list.V1beta1InferenceServiceList()  # noqa: E501
        if include_optional :
            return V1beta1InferenceServiceList(
                api_version = '0', 
                items = [
                    kfserving.models.v1beta1_inference_service.V1beta1InferenceService(
                        api_version = '0', 
                        kind = '0', 
                        metadata = None, 
