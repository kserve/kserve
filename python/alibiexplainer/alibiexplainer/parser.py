...
def addCommonParserArgs(parser):
    parser.add_argument('--threshold', type=float, action=GroupedAction,
                                       dest='explainer.threshold', default=argparse.SUPPRESS)
    parser.add_argument('--delta', type=float, action=GroupedAction,
                                       dest='explainer.delta', default=argparse.SUPPRESS)
    parser.add_argument('--tau', type=float, action=GroupedAction,
                                       dest='explainer.tau',
                                       default=argparse.SUPPRESS)
    parser.add_argument('--batch_size', type=int, action=GroupedAction,
                                       dest='explainer.batch_size', default=argparse.SUPPRESS)
    parser.add_argument('--coverage_samples', type=int, action=GroupedAction,
                                       dest='explainer.coverage_samples', default=argparse.SUPPRESS)
    parser.add_argument('--beam_size', type=int, action=GroupedAction,
                                       dest='explainer.beam_size', default=argparse.SUPPRESS)
    parser.add_argument('--stop_on_first', type=str2bool, action=GroupedAction,
                                       dest='explainer.stop_on_first', default=argparse.SUPPRESS)
    parser.add_argument('--max_anchor_size', type=int, action=GroupedAction,
                                       dest='explainer.max_anchor_size', default=argparse.SUPPRESS)
    parser.add_argument('--max_samples_start', type=int, action=GroupedAction,
                                       dest='explainer.max_samples_start',
                                       default=argparse.SUPPRESS)
    parser.add_argument('--n_covered_ex', type=int, action=GroupedAction,
                                       dest='explainer.n_covered_ex', default=argparse.SUPPRESS)
    parser.add_argument('--binary_cache_size', type=int, action=GroupedAction,
                                       dest='explainer.binary_cache_size',
                                       default=argparse.SUPPRESS)
    parser.add_argument('--cache_margin', type=int, action=GroupedAction,
                                       dest='explainer.cache_margin', default=argparse.SUPPRESS)
    parser.add_argument('--verbose', type=str2bool, action=GroupedAction,
                                       dest='explainer.verbose', default=argparse.SUPPRESS)
    parser.add_argument('--verbose_every', type=int, action=GroupedAction,
...
def parse_args(sys_args):
    ...
    parser_anchor_text.add_argument('--top_n', type=int, action=GroupedAction,
                                dest='explainer.top_n', default=argparse.SUPPRESS)
