...
**response** | **bool** | specify this step response be returned alongside final step response in sequence node final step response will always be returned | [optional] 
