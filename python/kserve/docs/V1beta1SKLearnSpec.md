...
json = "{}"
# create an instance of V1beta1SKLearnSpec from a JSON string
v1beta1_sk_learn_spec_instance = V1beta1SKLearnSpec.from_json(json)
# print the JSON string representation of the object
print V1beta1SKLearnSpec.to_json()

# convert the object into a dict
v1beta1_sk_learn_spec_dict = v1beta1_sk_learn_spec_instance.to_dict()
# create an instance of V1beta1SKLearnSpec from a dict
v1beta1_sk_learn_spec_form_dict = v1beta1_sk_learn_spec.from_dict(v1beta1_sk_learn_spec_dict)
```
