...
v1beta1_predictor_spec_instance = V1beta1PredictorSpec.from_json(json)
# print the JSON string representation of the object
print V1beta1PredictorSpec.to_json()

# convert the object into a dict
v1beta1_predictor_spec_dict = v1beta1_predictor_spec_instance.to_dict()
# create an instance of V1beta1PredictorSpec from a dict
v1beta1_predictor_spec_form_dict = v1beta1_predictor_spec.from_dict(v1beta1_predictor_spec_dict)
```
