...
v1alpha1_serving_runtime_spec_instance = V1alpha1ServingRuntimeSpec.from_json(json)
# print the JSON string representation of the object
print V1alpha1ServingRuntimeSpec.to_json()

# convert the object into a dict
v1alpha1_serving_runtime_spec_dict = v1alpha1_serving_runtime_spec_instance.to_dict()
# create an instance of V1alpha1ServingRuntimeSpec from a dict
v1alpha1_serving_runtime_spec_form_dict = v1alpha1_serving_runtime_spec.from_dict(v1alpha1_serving_runtime_spec_dict)
```
