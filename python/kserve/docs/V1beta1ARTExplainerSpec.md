...
**type** | **str** | The type of ART explainer | [default to '']
...
v1beta1_art_explainer_spec_instance = V1beta1ARTExplainerSpec.from_json(json)
# print the JSON string representation of the object
print V1beta1ARTExplainerSpec.to_json()

# convert the object into a dict
v1beta1_art_explainer_spec_dict = v1beta1_art_explainer_spec_instance.to_dict()
# create an instance of V1beta1ARTExplainerSpec from a dict
v1beta1_art_explainer_spec_form_dict = v1beta1_art_explainer_spec.from_dict(v1beta1_art_explainer_spec_dict)
```
