...
class TestV1alpha1ClusterStorageContainer(unittest.TestCase):
    """V1alpha1ClusterStorageContainer unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = kserve.models.v1alpha1_cluster_storage_container.V1alpha1ClusterStorageContainer()  # noqa: E501
        if include_optional:
            return V1alpha1ClusterStorageContainer(
                api_version="0",
                disabled=True,
                kind="0",
                metadata=None,
    ...
    def testV1alpha1ClusterStorageContainer(self):
        """Test V1alpha1ClusterStorageContainer"""
