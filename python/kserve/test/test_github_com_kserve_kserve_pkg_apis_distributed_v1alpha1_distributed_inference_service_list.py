...
import kserve
from kserve.models.github_com_kserve_kserve_pkg_apis_distributed_v1alpha1_distributed_inference_service_list import (
...
class TestGithubComKserveKservePkgApisDistributedV1alpha1DistributedInferenceServiceList(
    unittest.TestCase
):
    ...
    def make_instance(self, include_optional):
        ...
        if include_optional:
            return GithubComKserveKservePkgApisDistributedV1alpha1DistributedInferenceServiceList(
                api_version="0",
                items=[
                    kserve.models.github_com_kserve_kserve_pkg_apis_distributed_v1alpha1_distributed_inference_service.GithubComKserveKservePkgApisDistributedV1alpha1DistributedInferenceService(
                        api_version="0",
                        kind="0",
                        metadata=None,
                        spec=None,
    ...
    def testGithubComKserveKservePkgApisDistributedV1alpha1DistributedInferenceServiceList(
        self,
    ):
        """Test GithubComKserveKservePkgApisDistributedV1alpha1DistributedInferenceServiceList"""
