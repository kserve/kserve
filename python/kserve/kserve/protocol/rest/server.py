    ...
    def create_application(self) -> FastAPI:
        ...
        return FastAPI(
            ...
            routes=[
                ...
                # FastAPIRoute(r"/v2/models/{model_name}/chat/completions",
                #             v2_endpoints.create_chat_completion, methods=["POST"], tags=["V2"]),
                FastAPIRoute(r"/v2/models/{model_name}/completions",
                            v2_endpoints.completions, methods=["POST"], tags=["V2"]),
