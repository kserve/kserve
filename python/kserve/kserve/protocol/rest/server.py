        ...
        return FastAPI(
            ...
            routes=[
                ...
                FastAPIRoute(r"/v2/models/{model_name}/generate",
                             v2_endpoints.generate, methods=["POST"], response_model=InferenceResponse, tags=["V2"]),
                FastAPIRoute(r"/v2/models/{model_name}/generate_stream",
                             v2_endpoints.generate_stream, methods=["POST"], response_model=InferenceResponse, tags=["V2"]),
