...
#   timestamp: 2024-04-11T20:02:24+00:00
...
class AssistantToolsRetrieval(BaseModel):
    type: Type10 = Field(..., description='The type of tool being defined: `retrieval`')
...
class AssistantToolsFunction(BaseModel):
    type: Type11 = Field(..., description='The type of tool being defined: `function`')
...
class MessageContentImageFileObject(BaseModel):
    type: Type14 = Field(..., description='Always `image_file`.')
...
class MessageContentTextAnnotationsFileCitationObject(BaseModel):
    type: Type17 = Field(..., description='Always `file_citation`.')
    text: str = Field(
...
class MessageContentTextAnnotationsFilePathObject(BaseModel):
    type: Type18 = Field(..., description='Always `file_path`.')
    text: str = Field(
        ..., description='The text in the message content that needs to be replaced.'
    )
    file_path: FilePath
...
class RunStepDetailsMessageCreationObject(BaseModel):
    type: Type23 = Field(..., description='Always `message_creation`.')
...
class RunStepDetailsToolCallsCodeOutputLogsObject(BaseModel):
    type: Type29 = Field(..., description='Always `logs`.')
    logs: str = Field(
...
class RunStepDetailsToolCallsCodeOutputImageObject(BaseModel):
    type: Type31 = Field(..., description='Always `image`.')
    image: Image1
...
class MessageContentTextObject(BaseModel):
    type: Type16 = Field(..., description='Always `text`.')
    text: Text
...
class RunStepDetailsToolCallsObject(BaseModel):
    type: Type25 = Field(..., description='Always `tool_calls`.')
    tool_calls: List[
        Union[
