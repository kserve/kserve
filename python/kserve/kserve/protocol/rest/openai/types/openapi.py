...
from typing_extensions import Annotated, Required, TypedDict, TypeAlias, TypedDict, Literal
    ...
    def __post_init__(self) -> None:
        ...
        if 0 < self.temperature < _MAX_TEMP:
            logger.warning(
                ...
                self.temperature, _MAX_TEMP, _MAX_TEMP)  # TODO:
...
try:
    from sphinx.ext.autodoc.mock import _MockModule # TODO
...
class ChatCompletionResponse(OpenAIBaseModel):
    id: str = Field(default_factory=lambda: f"chatcmpl-{random_uuid()}") #TODO: Check this
...
class ChatCompletionStreamResponse(OpenAIBaseModel):
    id: str = Field(default_factory=lambda: f"chatcmpl-{random_uuid()}") #TODO: finish this
...
"""
CreateCompletionRequest is replaced by CompletionRequest
CreateChatCompletionRequest is replaced by  ChatCompletionRequest
Logprobs is replaced by CompletionLogProbs
ChatCompletionStreamResponseDelta is replaced by DeltaMessage
ChatCompletionTokenLogprob is replaced by ChatCompletionLogprob
Logprobs2 is replaced by ChatCompletionLogProbs
Choice3 replaced by ChatCompletionResponseStreamChoice
CreateChatCompletionStreamResponse is Replaced by ChatCompletionStreamResponse
CreateCompletionResponse is replaced by CompletionResponse
ChatCompletionResponseMessage is replaced by ChatMessage
Choice is replace by CompletionResponseChoice
Choice1 is replaced by ChatCompletionResponseChoice
CreateChatCompletionResponse is replaced by ChatCompletionResponse
"""
