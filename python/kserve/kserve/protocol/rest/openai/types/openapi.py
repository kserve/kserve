...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    temperature: Optional[float] = 1.0 # TODO: Make it the same as CompletionRequest so that it can pass tests, but I do not think those tests are necessary
    top_p: Optional[float] = 1.0
...
class ChatMessage(OpenAIBaseModel):
    role: str
    content: Optional[str] = None
    tool_calls: Optional[List[ToolCall]] = None  # TODO: Make it None, but I do not think those tests are necessary, probably change it back to list later
