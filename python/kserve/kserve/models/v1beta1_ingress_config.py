...
class V1beta1IngressConfig(object):
    ...
    def __init__(
        ...
        model_based_routing_header_name=None,
        model_based_routing_mode=None,
        path_template=None,
        raw_deployment=None,
        url_scheme=None,
    ...
    def disable_http_route_timeout(self):
        ...
        Deprecated: use rawDeployment.disableHTTPRouteTimeout instead. Kept for backward compatibility; at runtime, either field set to true disables HTTPRoute timeouts.  # noqa: E501
