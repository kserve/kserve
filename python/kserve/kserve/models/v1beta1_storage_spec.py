...
class V1beta1StorageSpec(BaseModel):
    ...
    path: Optional[StrictStr] = Field(default=None, description="The path to the model object in the storage. It cannot co-exist with the storageURI.")
    ...
    __properties: ClassVar[List[str]] = ["key", "parameters", "path", "schemaPath"]
