...
class V1beta1StorageSpec(object):
    ...
    """
    openapi_types = {"key": "str", "parameters": "dict(str, str)", "path": "str"}

    attribute_map = {"key": "key", "parameters": "parameters", "path": "path"}

    def __init__(
        self, key=None, parameters=None, path=None, local_vars_configuration=None
    ):  # noqa: E501
