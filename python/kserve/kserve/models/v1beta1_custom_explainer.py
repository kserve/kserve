...
class V1beta1CustomExplainer(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1beta1CustomExplainer from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of V1beta1CustomExplainer from a dict"""
        if obj is None:
            return None
