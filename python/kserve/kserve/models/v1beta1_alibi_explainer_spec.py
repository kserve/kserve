...
class V1beta1AlibiExplainerSpec(BaseModel):
    """
    ...
    type: StrictStr = Field(description="The type of Alibi explainer <br /> Valid values are: <br /> - \"AnchorTabular\"; <br /> - \"AnchorImages\"; <br /> - \"AnchorText\"; <br /> - \"Counterfactuals\"; <br /> - \"Contrastive\"; <br />")
