...
class V1beta1ServiceConfig(object):
    ...
    """
    openapi_types = {"service_cluster_ip_none": "bool"}

    attribute_map = {"service_cluster_ip_none": "serviceClusterIPNone"}

    def __init__(
        self, service_cluster_ip_none=None, local_vars_configuration=None
    ):  # noqa: E501
