...
class V1beta1ModelCopies(object):
    ...
    def __init__(self, failed_copies=0, total_copies=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._failed_copies = None
        self._total_copies = None
        self.discriminator = None

        self.failed_copies = failed_copies
        if total_copies is not None:
            self.total_copies = total_copies

    @property
    def failed_copies(self):
        ...
        :return: The failed_copies of this V1beta1ModelCopies.  # noqa: E501
        :rtype: int
        """
        return self._failed_copies
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1beta1ModelCopies):
            return False
