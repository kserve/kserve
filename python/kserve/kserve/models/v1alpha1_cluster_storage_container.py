...
class V1alpha1ClusterStorageContainer(BaseModel):
    """
    ...
    spec: Optional[V1alpha1StorageContainerSpec] = None
    __properties: ClassVar[List[str]] = ["apiVersion", "disabled", "kind", "metadata", "spec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1StorageContainerSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
