...
class V1beta1ResourceMetricSource(object):
    ...
    """
    openapi_types = {"name": "str", "target": "V1beta1MetricTarget"}

    attribute_map = {"name": "name", "target": "target"}

    def __init__(
        self, name="", target=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def name(self):
        ...
        :return: The name of this V1beta1ResourceMetricSource.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def target(self):
        ...
        :return: The target of this V1beta1ResourceMetricSource.  # noqa: E501
