...
class V1beta1PredictorSpec(object):
    ...
    @property
    def name(self):
        """Gets the name of this V1beta1PredictorSpec.  # noqa: E501

        Name optionally identifies this predictor variant. When set, the Deployment and Service are named {isvc}-{name}-predictor instead of the default {isvc}-predictor. Required when used in a canary entry.  # noqa: E501

        :return: The name of this V1beta1PredictorSpec.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1beta1PredictorSpec.

        Name optionally identifies this predictor variant. When set, the Deployment and Service are named {isvc}-{name}-predictor instead of the default {isvc}-predictor. Required when used in a canary entry.  # noqa: E501

        :param name: The name of this V1beta1PredictorSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def openvino(self):
        """Gets the openvino of this V1beta1PredictorSpec.  # noqa: E501


        :return: The openvino of this V1beta1PredictorSpec.  # noqa: E501
        :rtype: V1beta1OpenVINOSpec
        """
        return self._openvino

    @openvino.setter
    def openvino(self, openvino):
        """Sets the openvino of this V1beta1PredictorSpec.


        :param openvino: The openvino of this V1beta1PredictorSpec.  # noqa: E501
        :type: V1beta1OpenVINOSpec
        """
    ...
    def scheduling_group(self):
        """Gets the scheduling_group of this V1beta1PredictorSpec.  # noqa: E501


        :return: The scheduling_group of this V1beta1PredictorSpec.  # noqa: E501
    ...
    def scheduling_group(self, scheduling_group):
        """Sets the scheduling_group of this V1beta1PredictorSpec.


        :param scheduling_group: The scheduling_group of this V1beta1PredictorSpec.  # noqa: E501
    ...
    def storage_container_name(self):
        """Gets the storage_container_name of this V1beta1PredictorSpec.  # noqa: E501

        StorageContainerName specifies the name of the ClusterStorageContainer to use for downloading model artifacts. When set, this ClusterStorageContainer is used instead of auto-matching based on the storage URI scheme. This is similar to storageClassName on PersistentVolumeClaims.  # noqa: E501

        :return: The storage_container_name of this V1beta1PredictorSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_container_name(self, storage_container_name):
        """Sets the storage_container_name of this V1beta1PredictorSpec.

        StorageContainerName specifies the name of the ClusterStorageContainer to use for downloading model artifacts. When set, this ClusterStorageContainer is used instead of auto-matching based on the storage URI scheme. This is similar to storageClassName on PersistentVolumeClaims.  # noqa: E501

        :param storage_container_name: The storage_container_name of this V1beta1PredictorSpec.  # noqa: E501
        :type: str
        """
