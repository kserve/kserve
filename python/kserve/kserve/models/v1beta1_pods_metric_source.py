...
class V1beta1PodsMetricSource(object):
    ...
    def __init__(self, backend=None, metric_names=None, operation_over_time=None, query=None, server_address=None, local_vars_configuration=None):  # noqa: E501
    ...
    def metric_names(self):
        """Gets the metric_names of this V1beta1PodsMetricSource.  # noqa: E501

        MetricNames is the list of metric names in the backend.  # noqa: E501

        :return: The metric_names of this V1beta1PodsMetricSource.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def metric_names(self, metric_names):
        """Sets the metric_names of this V1beta1PodsMetricSource.

        MetricNames is the list of metric names in the backend.  # noqa: E501

        :param metric_names: The metric_names of this V1beta1PodsMetricSource.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1beta1PodsMetricSource):
            return False
