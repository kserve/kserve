...
class V1beta1ExplainerSpec(BaseModel):
    """
    ...
    alibi: Optional[V1beta1AlibiExplainerSpec] = None
    ...
    __properties: ClassVar[List[str]] = ["activeDeadlineSeconds", "affinity", "alibi", "annotations", "art", "automountServiceAccountToken", "batcher", "canaryTrafficPercent", "containerConcurrency", "containers", "dnsConfig", "dnsPolicy", "enableServiceLinks", "ephemeralContainers", "hostAliases", "hostIPC", "hostNetwork", "hostPID", "hostUsers", "hostname", "imagePullSecrets", "initContainers", "labels", "logger", "maxReplicas", "minReplicas", "nodeName", "nodeSelector", "os", "overhead", "preemptionPolicy", "priority", "priorityClassName", "readinessGates", "resourceClaims", "restartPolicy", "runtimeClassName", "scaleMetric", "scaleTarget", "schedulerName", "schedulingGates", "securityContext", "serviceAccount", "serviceAccountName", "setHostnameAsFQDN", "shareProcessNamespace", "subdomain", "terminationGracePeriodSeconds", "timeout", "tolerations", "topologySpreadConstraints", "volumes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1beta1ExplainerSpec from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of alibi
        if self.alibi:
            _dict['alibi'] = self.alibi.to_dict()
        # override the default output from pydantic by calling `to_dict()` of art
        if self.art:
            _dict['art'] = self.art.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of V1beta1ExplainerSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "alibi": V1beta1AlibiExplainerSpec.from_dict(obj.get("alibi")) if obj.get("alibi") is not None else None,
            "annotations": obj.get("annotations"),
            "art": V1beta1ARTExplainerSpec.from_dict(obj.get("art")) if obj.get("art") is not None else None,
