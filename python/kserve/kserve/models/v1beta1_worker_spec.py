...
class V1beta1WorkerSpec(object):
    ...
    def eviction_responders(self):
        """Gets the eviction_responders of this V1beta1WorkerSpec.  # noqa: E501
        ...
        :return: The eviction_responders of this V1beta1WorkerSpec.  # noqa: E501
    ...
    def eviction_responders(self, eviction_responders):
        """Sets the eviction_responders of this V1beta1WorkerSpec.

        EvictionResponders reference responders that react to Evictions based on EvictionRequests. Responders should observe and communicate through the Eviction Resource API to help with the graceful termination of a pod. The responders are selected sequentially, according to their specified priority.  The maximum length of the responders list is 10. Responders are not supported when the pod is part of a PodGroup (.spec.schedulingGroup is set). This field can only be set on creation and is immutable afterwards.  # noqa: E501

        :param eviction_responders: The eviction_responders of this V1beta1WorkerSpec.  # noqa: E501
    ...
    def hostname_override(self):
        """Gets the hostname_override of this V1beta1WorkerSpec.  # noqa: E501
        ...
        :return: The hostname_override of this V1beta1WorkerSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def hostname_override(self, hostname_override):
        """Sets the hostname_override of this V1beta1WorkerSpec.

        HostnameOverride specifies an explicit override for the pod's hostname as perceived by the pod. This field only specifies the pod's hostname and does not affect its DNS records. When this field is set to a non-empty string: - It takes precedence over the values set in `hostname` and `subdomain`. - The Pod's hostname will be set to this value. - `setHostnameAsFQDN` must be nil or set to false. - `hostNetwork` must be set to false.  This field must be a valid DNS subdomain as defined in RFC 1123 and contain at most 64 characters. Requires the HostnameOverride feature gate to be enabled.  # noqa: E501

        :param hostname_override: The hostname_override of this V1beta1WorkerSpec.  # noqa: E501
        :type: str
        """
    ...
    def resources(self):
        ...
        :return: The resources of this V1beta1WorkerSpec.  # noqa: E501
    ...
    def resources(self, resources):
        ...
        :param resources: The resources of this V1beta1WorkerSpec.  # noqa: E501
