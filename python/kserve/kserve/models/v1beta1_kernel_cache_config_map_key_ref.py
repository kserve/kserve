...
class V1beta1KernelCacheConfigMapKeyRef(object):
    ...
    def __init__(self, key='', name='', local_vars_configuration=None):  # noqa: E501
        """V1beta1KernelCacheConfigMapKeyRef - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1beta1KernelCacheConfigMapKeyRef):
            return False
