...
class V1beta1DeployConfig(object):
    ...
    """
    openapi_types = {"default_deployment_mode": "str"}

    attribute_map = {"default_deployment_mode": "defaultDeploymentMode"}

    def __init__(
        self, default_deployment_mode=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def default_deployment_mode(self):
        ...
        :return: The default_deployment_mode of this V1beta1DeployConfig.  # noqa: E501
        :rtype: str
        """
        return self._default_deployment_mode

    @default_deployment_mode.setter
    def default_deployment_mode(self, default_deployment_mode):
        """Sets the default_deployment_mode of this V1beta1DeployConfig.


        :param default_deployment_mode: The default_deployment_mode of this V1beta1DeployConfig.  # noqa: E501
        :type: str
        """
