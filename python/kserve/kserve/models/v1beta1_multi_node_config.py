...
class V1beta1MultiNodeConfig(object):
    ...
    """
    openapi_types = {"custom_gpu_resource_type_list": "list[str]"}

    attribute_map = {"custom_gpu_resource_type_list": "customGPUResourceTypeList"}

    def __init__(
        self, custom_gpu_resource_type_list=None, local_vars_configuration=None
    ):  # noqa: E501
