...
class V1beta1ModelSpec(BaseModel):
    ...
    protocol_version: Optional[StrictStr] = Field(default=None, description="Protocol version to use by the predictor (i.e. v1 or v2 or grpc-v1 or grpc-v2)", alias="protocolVersion")
    ...
    runtime: Optional[StrictStr] = Field(default=None, description="Specific ClusterServingRuntime/ServingRuntime name to use for deployment.")
    runtime_version: Optional[StrictStr] = Field(default=None, description="Runtime version of the predictor docker image", alias="runtimeVersion")
    ...
    storage_uri: Optional[StrictStr] = Field(default=None, description="This field points to the location of the trained model which is mounted onto the pod.", alias="storageUri")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "modelFormat": V1beta1ModelFormat.from_dict(obj.get("modelFormat")) if obj.get("modelFormat") is not None else None,
