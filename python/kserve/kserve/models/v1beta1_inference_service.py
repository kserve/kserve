...
class V1beta1InferenceService(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1InferenceServiceSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": V1beta1InferenceServiceStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
