...
class V1alpha1ServingRuntimeSpec(object):
    ...
    def replicas(self):
        ...
        Configure the number of replicas in the Deployment generated by this ServingRuntime If specified, this overrides the podsPerRuntime configuration value. Note: This configuration is ModelMesh-specific and does not have any effect for non-ModelMesh InferenceServices.  # noqa: E501
