...
async def test_single_embedding(client: openai.AsyncOpenAI, model_name: str):
    ...
    embeddings = Embedding.model_validate(embedding_response.model_dump(mode="json"))
...
#         encoding_format="float",
#     )
#     embeddings = Embedding.model_validate(
...
#     chat_embeddings = Embedding.model_validate(chat_response.json())
...
#     )
#     completion_embeddings = Embedding.model_validate(
