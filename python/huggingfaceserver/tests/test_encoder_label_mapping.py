...
class TestEncoderLabelMapping:
    ...
    def test_get_label_or_index_with_valid_labels(self, encoder_model_with_labels):
        ...
        with patch.object(model, "_model", None), patch.object(
    ...
    def test_get_label_or_index_without_labels_with_warning(
        self, encoder_model_without_labels: HuggingfaceEncoderModel
    ):
