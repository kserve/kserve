...
class HuggingfaceEncoderModel(
    ...
    async def create_embedding(self, request: EmbeddingRequest) -> Embedding:
        ...
        # Llangchain attempt to determine the proper tokenization based on the model name and will fall back to the
        ...
        # The autogenerated OpenAPI specification doesn't seem to include the base64 encoding option. Add it.
        class EmbeddingObjectWithBase64Support(EmbeddingObject):
            embedding: List[float] | str

        return Embedding(
            object="list",
            data=[
                EmbeddingObjectWithBase64Support(
                    object="embedding",
                    index=i,
                    embedding=o,
                )
