...
from .completion_base import OpenAIServing
...
class OpenAIServingCompletion(OpenAIServing):
    ...
    async def create_completion(self, request: CompletionRequest,
        ...
        NOTE: Currently the following feature not supported:
            - suffix (the language models vllm currently support do not support
            suffix)
        """
