...
var (
	KFServingGKEAcceleratorAnnotationKey = KFServingAPIGroupName + "/gke-accelerator"
)
...
var (
	...
	DeploymentMutatorWebhookName                = strings.Join([]string{InferenceServiceName, WebhookServerName, "deployment-mutator"}, ".")
