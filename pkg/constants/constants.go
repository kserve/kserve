...
func VirtualServiceHostname(predictorHostName string) string {
	return strings.ReplaceAll(predictorHostName, fmt.Sprintf("-%s-%s", string(Predictor), InferenceServiceDefault), "")
}
