...
func TestReconcile(t *testing.T) {
	...
	// // Create test configmap in KServe namespace
	...
	// 	},
	// 	Data: map[string]string{
	// 		constants.DefaultCaBundleFileName: caBundleContent,
	// 	},
	// }

	// Create InferenceService configmap with storage initializer config
	// storageConfig := pod.StorageInitializerConfig{
	// 	CaBundleConfigMapName: "test-cabundle-cm",
	// }
	// storageConfigBytes, _ := json.Marshal(storageConfig)
	...
	// 	},
	// 	Data: map[string]string{
	// 		"storageInitializer": string(storageConfigBytes),
	// 	},
	// }
