...
func NewAutoscalerReconciler(client client.Client,
	...
	as, err := createAutoscaler(client, scheme, componentMeta, componentExt, autoscalerConfig, otelCollectorConfig)
	if err != nil {
		return nil, err
	}
...
func createAutoscaler(client client.Client,
	...
	case constants.AutoscalerClassKeda:
		return keda.NewKedaReconciler(client, scheme, componentMeta, componentExt, autoscalerConfig, otelCollectorConfig)
	default:
