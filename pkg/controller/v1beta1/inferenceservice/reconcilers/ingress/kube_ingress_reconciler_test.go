	...
	testCases := []struct {
	...
	}{
		{
			...
			input: map[string]string{
				...
				"serving.kserve.io/nodeports":                        "8080:30000",
...
func TestMergeAnnotations(t *testing.T) {
	...
	g.Expect(ingressAnnotations).To(gomega.HaveKey("serving.kserve.io/enable-nodeport"))
	...
	g.Expect(ingressAnnotations["serving.kserve.io/enable-nodeport"]).To(gomega.Equal("true"))
