...
func TestReconcileCreate(t *testing.T) {
	...
	err = client.Get(context.Background(), types.NamespacedName{Name: componentMeta.Name, Namespace: componentMeta.Namespace}, collector)
	require.NoError(t, err)
	assert.NoError(t, err)
...
func TestReconcileUpdate(t *testing.T) {
	...
	err = client.Get(context.Background(), types.NamespacedName{Name: componentMeta.Name, Namespace: componentMeta.Namespace}, updatedCollector)
	require.NoError(t, err)
	assert.NoError(t, err)
