...
func WithConfigManagedScheduler() LLMInferenceServiceConfigOption {
	return func(config *v1alpha1.LLMInferenceServiceConfig) {
		...
		config.Spec.Router.Scheduler = &v1alpha1.SchedulerSpec{}
	}
}
...
func WithConfigSchedulerConfigInline(configYAML string) LLMInferenceServiceConfigOption {
	return func(config *v1alpha1.LLMInferenceServiceConfig) {
		...
		config.Spec.Router.Scheduler.Config = &v1alpha1.SchedulerConfigSpec{
...
func WithSchedulerConfigInline(configYAML string) LLMInferenceServiceOption {
	return func(llmSvc *v1alpha1.LLMInferenceService) {
		...
		llmSvc.Spec.Router.Scheduler.Config = &v1alpha1.SchedulerConfigSpec{
			Inline: &runtime.RawExtension{Raw: jsonBytes},
		}
	}
}
...
func ensureSchedulerSpec(spec *v1alpha1.LLMInferenceServiceSpec) {
	if spec.Router == nil {
		spec.Router = &v1alpha1.RouterSpec{}
	}
	if spec.Router.Scheduler == nil {
		spec.Router.Scheduler = &v1alpha1.SchedulerSpec{}
	}
}
