...
func NewLocalModelNodeGroupReconciler(client client.Client, clientset kubernetes.Interface, log logr.Logger, scheme *runtime.Scheme) *LocalModelNodeGroupReconciler {
...
// reconcileDaemonSet creates or updates the Local Model Agent DaemonSet
