...
func (r *RouteBuilder) CreateKnativeRoute(kfsvc *v1alpha1.KFService) *v1beta1.Route {
	defaultPercent := 100
	canaryPercent := 0
	...
	trafficTargets := []v1beta1.TrafficTarget{
	...
	if kfsvc.Spec.Canary != nil {
		trafficTargets = append(trafficTargets, v1beta1.TrafficTarget{
