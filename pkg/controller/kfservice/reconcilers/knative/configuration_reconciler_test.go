...
func TestKnativeConfigurationReconcile(t *testing.T) {
	...
	scenarios := map[string]struct {
		...
		desiredDefault *v1beta1.Configuration
		desiredCanary  *v1beta1.Configuration
	}{
...
func awaitDesired(c client.Client, desired *v1beta1.Configuration) error {
	if desired == nil {
		return nil
	}
	actual := v1beta1.Configuration{}
