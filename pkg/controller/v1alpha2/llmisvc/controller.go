...
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterrolebindings,verbs=get;update;patch,resourceNames=kserve-llmisvc-scheduler-auth-delegators
