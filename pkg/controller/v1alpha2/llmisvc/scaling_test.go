...
func TestNamingHelpers(t *testing.T) {
	...
	t.Run("legacy main VA name", func(t *testing.T) {
		assert.Equal(t, "sim-llama-kserve-va", legacyMainVAName(svc))
	})

	t.Run("legacy prefill VA name", func(t *testing.T) {
		assert.Equal(t, "sim-llama-kserve-prefill-va", legacyPrefillVAName(svc))
	})
