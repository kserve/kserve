...
// TestSingleNodePipelineParallelRendered verifies that spec.parallelism.pipeline is rendered
// into --pipeline-parallel-size for single-node (no Worker) templates.
