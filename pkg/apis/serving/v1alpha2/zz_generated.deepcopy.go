...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrepostprocessSpec) DeepCopyInto(out *PrepostprocessSpec) {
	*out = *in
	if in.Custom != nil {
		in, out := &in.Custom, &out.Custom
		*out = new(CustomSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrepostprocessSpec.
func (in *PrepostprocessSpec) DeepCopy() *PrepostprocessSpec {
	if in == nil {
		return nil
	}
	out := new(PrepostprocessSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServicesSpec) DeepCopyInto(out *ServicesSpec) {
	*out = *in
	if in.Prepostprocess != nil {
		in, out := &in.Prepostprocess, &out.Prepostprocess
		*out = new(PrepostprocessSpec)
		(*in).DeepCopyInto(*out)
	}
