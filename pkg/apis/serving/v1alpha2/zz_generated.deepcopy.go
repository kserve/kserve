...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InferenceLogger) DeepCopyInto(out *InferenceLogger) {
	*out = *in
	if in.Url != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InferenceLogger.
func (in *InferenceLogger) DeepCopy() *InferenceLogger {
	if in == nil {
		return nil
	}
	out := new(InferenceLogger)
