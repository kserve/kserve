...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InferenceEndpointsConfigMap) DeepCopyInto(out *InferenceEndpointsConfigMap) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InferenceEndpointsConfigMap.
func (in *InferenceEndpointsConfigMap) DeepCopy() *InferenceEndpointsConfigMap {
	if in == nil {
		return nil
	}
	out := new(InferenceEndpointsConfigMap)
	in.DeepCopyInto(out)
	return out
}
