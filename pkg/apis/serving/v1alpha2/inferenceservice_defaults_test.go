...
func TestPyTorchDefaults(t *testing.T) {
	...
	isvc.Spec.Canary = isvc.Spec.Default.DeepCopy()
	isvc.Spec.Canary.Predictor.PyTorch.RuntimeVersion = "0.2.1"
	...
	g.Expect(isvc.Spec.Canary.Predictor.PyTorch.RuntimeVersion).To(gomega.Equal("0.2.1"))
...
func TestSKLearnDefaults(t *testing.T) {
	...
	isvc.Spec.Canary = isvc.Spec.Default.DeepCopy()
	isvc.Spec.Canary.Predictor.SKLearn.RuntimeVersion = "0.2.1"
	...
	g.Expect(isvc.Spec.Canary.Predictor.SKLearn.RuntimeVersion).To(gomega.Equal("0.2.1"))
...
func TestXGBoostDefaults(t *testing.T) {
	...
	isvc.Spec.Canary = isvc.Spec.Default.DeepCopy()
	isvc.Spec.Canary.Predictor.XGBoost.RuntimeVersion = "0.2.1"
	...
	g.Expect(isvc.Spec.Canary.Predictor.XGBoost.RuntimeVersion).To(gomega.Equal("0.2.1"))
