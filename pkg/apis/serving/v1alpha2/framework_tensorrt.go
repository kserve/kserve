...
func (t *TensorRTSpec) GetContainer(modelName string, hasLogging bool, config *InferenceServicesConfig) *v1.Container {
	...
	return &v1.Container{
		...
		Args: []string{
			...
			"--http-port=" + constants.GetInferenceServiceHttpPort(hasLogging),
		},
