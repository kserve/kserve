...
func (ss *InferenceServiceStatus) PropagateDefaultPredictorStatus(defaultStatus *knservingv1alpha1.ServiceStatus) {
...
// to the Service status.
func (ss *InferenceServiceStatus) PropagateCanaryPredictorStatus(canaryStatus *knservingv1alpha1.ServiceStatus) {
...
func (ss *InferenceServiceStatus) PropagateRouteStatus(rs *knservingv1alpha1.RouteStatus) {
