...
func (c *CustomSpec) GetContainer(modelName string, config *InferenceServicesConfig, hasLogging bool) *v1.Container {
	return &c.Container
}

func (c *CustomSpec) CreateExplainerContainer(modelName string, predictUrl string, config *InferenceServicesConfig, hasLogging bool) *v1.Container {
	return &c.Container
}
