...
// +kubebuilder:printcolumn:name="LatestReady",type="string",JSONPath=".status.components.predictor.traffic[?(@.tag=='latest')].revisionName"
// +kubebuilder:printcolumn:name="LatestTraffic",type="integer",JSONPath=".status.components.predictor.traffic[?(@.tag=='latest')].percent"
// +kubebuilder:printcolumn:name="PreviousRolledout",type="string",JSONPath=".status.components.predictor.traffic[?(@.tag=='prev')].revisionName"
// +kubebuilder:printcolumn:name="Traffic",type="integer",JSONPath=".status.components.predictor.traffic[?(@.tag=='prev')].percent"
