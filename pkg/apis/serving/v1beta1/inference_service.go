...
// +kubebuilder:printcolumn:name="Default",type="integer",JSONPath=".status.components.predictor.traffic[?(@.tag=='prev')].percent"
// +kubebuilder:printcolumn:name="Canary",type="integer",JSONPath=".status.components.predictor.traffic[?(@.tag=='latest')].percent"
