...
type PodSpec struct {
	...
	// +optional
	EvictionResponders []corev1.EvictionResponder `json:"evictionResponders,omitempty" patchStrategy:"merge" patchMergeKey:"name" protobuf:"bytes,44,rep,name=evictionResponders"`
}
