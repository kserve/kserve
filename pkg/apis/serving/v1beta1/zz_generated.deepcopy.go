...
func (in *DeployConfig) DeepCopyInto(out *DeployConfig) {
	*out = *in
	if in.AnnotationsPropagationDisallowList != nil {
		in, out := &in.AnnotationsPropagationDisallowList, &out.AnnotationsPropagationDisallowList
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.LabelsPropagationDisallowList != nil {
		in, out := &in.LabelsPropagationDisallowList, &out.LabelsPropagationDisallowList
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
