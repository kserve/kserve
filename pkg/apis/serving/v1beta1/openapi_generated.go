...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubeflow/kfserving/pkg/apis/serving/v1beta1.InferenceRouter":  schema_pkg_apis_serving_v1beta1_InferenceRouter(ref),
...
func schema_pkg_apis_serving_v1beta1_InferenceRouter(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubeflow/kfserving/pkg/apis/serving/v1beta1.InferenceRouterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubeflow/kfserving/pkg/apis/serving/v1beta1.InferenceRouterStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/kubeflow/kfserving/pkg/apis/serving/v1beta1.InferenceRouterSpec", "github.com/kubeflow/kfserving/pkg/apis/serving/v1beta1.InferenceRouterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}
