...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/serving/v1beta1.CatBoostSpec":            schema_pkg_apis_serving_v1beta1_CatBoostSpec(ref),
...
func schema_pkg_apis_serving_v1beta1_CatBoostSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CatBoostSpec defines arguments for configuring CatBoostSpec model serving.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"storageUri": {
						SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"catboost": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./pkg/apis/serving/v1beta1.CatBoostSpec"),
						},
					},
					"sklearn": {
						SchemaProps: spec.SchemaProps{
