		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"scaleTarget": {
						SchemaProps: spec.SchemaProps{
							Description: "ScaleTarget specifies scaling value of the component concurrency(https://knative.dev/docs/serving/autoscaling/autoscaling-targets/).",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"scaleMetric": {
						SchemaProps: spec.SchemaProps{
							Description: "ScaleMetric specifies scaling metric of the component concurrency(https://knative.dev/docs/serving/autoscaling/autoscaling-metrics/).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
