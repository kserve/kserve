		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"sklearn": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for SKLearn model server",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.SKLearnSpec"),
						},
					},
					"xgboost": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for XGBoost model server",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.XGBoostSpec"),
						},
					},
					"tensorflow": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for TFServing (https://github.com/tensorflow/serving)",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.TFServingSpec"),
						},
					},
					"pytorch": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for TorchServe (https://pytorch.org/serve)",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.TorchServeSpec"),
						},
					},
					"triton": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for Triton Inference Server (https://github.com/triton-inference-server/server)",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.TritonSpec"),
						},
					},
					"onnx": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for ONNX runtime (https://github.com/microsoft/onnxruntime)",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.ONNXRuntimeSpec"),
						},
					},
					"pmml": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for PMML (http://dmg.org/pmml/v4-1/GeneralStructure.html)",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.PMMLSpec"),
						},
					},
					"lightgbm": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for LightGBM model server",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1beta1.LightGBMSpec"),
						},
					},
					"paddle": {
						SchemaProps: spec.SchemaProps{
							Description: "Deprecated: This is deprecated in favor of Model field. Spec for Paddle model server (https://github.com/PaddlePaddle/Serving)",
