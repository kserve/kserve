...
type NodeCacheCounts struct {
	...
	// TotalPodsUsing - non-terminating pods using any cache on this node
...
type CacheNodeCacheInfo struct {
	...
	// PodsUsing is the number of non-terminating pods on this node currently mounting this cache
	// +optional
	PodsUsing int `json:"podsUsing,omitempty"`
