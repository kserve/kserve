...
var DefaultTensorflowVersion = "1.12"

// DefaultXGBoostVersion runs if not provided in XGBoostSpec
var DefaultXGBoostVersion = "1.12"

// DefaultScikitLearnVersion runs if not provided in ScikitLearnSpec
var DefaultScikitLearnVersion = "1.12"
