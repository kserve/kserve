...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GraphLoggerSpec) DeepCopyInto(out *GraphLoggerSpec) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GraphLoggerSpec.
func (in *GraphLoggerSpec) DeepCopy() *GraphLoggerSpec {
	if in == nil {
		return nil
	}
	out := new(GraphLoggerSpec)
	in.DeepCopyInto(out)
	return out
}
