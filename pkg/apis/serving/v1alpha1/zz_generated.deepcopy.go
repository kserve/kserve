...
func (in *StorageContainerSpec) DeepCopyInto(out *StorageContainerSpec) {
	*out = *in
	...
	in.StorageContainer.DeepCopyInto(&out.StorageContainer)
	if in.SupportedPrefixes != nil {
		in, out := &in.SupportedPrefixes, &out.SupportedPrefixes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SupportedRegexes != nil {
		in, out := &in.SupportedRegexes, &out.SupportedRegexes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
