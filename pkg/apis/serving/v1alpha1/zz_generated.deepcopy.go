...
func (in *InferenceRouter) DeepCopyInto(out *InferenceRouter) {
	*out = *in
	...
	if in.NextRoutes != nil {
		in, out := &in.NextRoutes, &out.NextRoutes
		*out = make([]RouteTo, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteTo) DeepCopyInto(out *RouteTo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteTo.
func (in *RouteTo) DeepCopy() *RouteTo {
	if in == nil {
		return nil
	}
	out := new(RouteTo)
