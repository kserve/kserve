...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMStorageSpec) DeepCopyInto(out *LLMStorageSpec) {
	*out = *in
	if in.Path != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMStorageSpec.
func (in *LLMStorageSpec) DeepCopy() *LLMStorageSpec {
	if in == nil {
		return nil
	}
	out := new(LLMStorageSpec)
