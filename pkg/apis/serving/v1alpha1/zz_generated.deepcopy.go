...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModelCacheFailureInfo) DeepCopyInto(out *ModelCacheFailureInfo) {
	*out = *in
	if in.Time != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModelCacheFailureInfo.
func (in *ModelCacheFailureInfo) DeepCopy() *ModelCacheFailureInfo {
	if in == nil {
		return nil
	}
	out := new(ModelCacheFailureInfo)
