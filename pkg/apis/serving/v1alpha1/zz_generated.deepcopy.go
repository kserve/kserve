...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheNodeCacheInfo) DeepCopyInto(out *CacheNodeCacheInfo) {
	*out = *in
	if in.CompatibleGPUs != nil {
		in, out := &in.CompatibleGPUs, &out.CompatibleGPUs
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
	if in.IncompatibleGPUs != nil {
		in, out := &in.IncompatibleGPUs, &out.IncompatibleGPUs
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
	if in.ServingNamespaces != nil {
		in, out := &in.ServingNamespaces, &out.ServingNamespaces
		*out = make(map[string]NamespaceServingCounts, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheNodeCacheInfo.
func (in *CacheNodeCacheInfo) DeepCopy() *CacheNodeCacheInfo {
	if in == nil {
		return nil
	}
	out := new(CacheNodeCacheInfo)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CreateKernelCacheConfig) DeepCopyInto(out *CreateKernelCacheConfig) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CreateKernelCacheConfig.
func (in *CreateKernelCacheConfig) DeepCopy() *CreateKernelCacheConfig {
	if in == nil {
		return nil
	}
	out := new(CreateKernelCacheConfig)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUCompatibilitySummary) DeepCopyInto(out *GPUCompatibilitySummary) {
	*out = *in
	if in.CompatibleTypes != nil {
		in, out := &in.CompatibleTypes, &out.CompatibleTypes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.IncompatibleTypes != nil {
		in, out := &in.IncompatibleTypes, &out.IncompatibleTypes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUCompatibilitySummary.
func (in *GPUCompatibilitySummary) DeepCopy() *GPUCompatibilitySummary {
	if in == nil {
		return nil
	}
	out := new(GPUCompatibilitySummary)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KernelCacheCaptureSpec) DeepCopyInto(out *KernelCacheCaptureSpec) {
	*out = *in
	...
	if in.CreateKernelCache != nil {
		in, out := &in.CreateKernelCache, &out.CreateKernelCache
		*out = new(CreateKernelCacheConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *KernelCacheNodeStatus) DeepCopyInto(out *KernelCacheNodeStatus) {
	*out = *in
	...
	if in.CacheStatus != nil {
		...
		*out = make(map[string]CacheNodeCacheInfo, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KernelCachePodTemplate) DeepCopyInto(out *KernelCachePodTemplate) {
	*out = *in
	if in.NodeSelector != nil {
		in, out := &in.NodeSelector, &out.NodeSelector
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KernelCachePodTemplate.
func (in *KernelCachePodTemplate) DeepCopy() *KernelCachePodTemplate {
	if in == nil {
		return nil
	}
	out := new(KernelCachePodTemplate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KernelCacheStatus) DeepCopyInto(out *KernelCacheStatus) {
	*out = *in
	...
	if in.GPUCompatibility != nil {
		in, out := &in.GPUCompatibility, &out.GPUCompatibility
		*out = new(GPUCompatibilitySummary)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceServingCounts) DeepCopyInto(out *NamespaceServingCounts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceServingCounts.
func (in *NamespaceServingCounts) DeepCopy() *NamespaceServingCounts {
	if in == nil {
		return nil
	}
	out := new(NamespaceServingCounts)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeCacheCounts) DeepCopyInto(out *NodeCacheCounts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeCacheCounts.
func (in *NodeCacheCounts) DeepCopy() *NodeCacheCounts {
	if in == nil {
		return nil
	}
	out := new(NodeCacheCounts)
...
func (in *ServingStatus) DeepCopyInto(out *ServingStatus) {
	*out = *in
	if in.NamespaceCounts != nil {
		in, out := &in.NamespaceCounts, &out.NamespaceCounts
		*out = make(map[string]NamespaceServingCounts, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
