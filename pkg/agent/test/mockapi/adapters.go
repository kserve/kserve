// This class is used to adapt instances of *storage.Client, and
// conform it to Client interface (found in storageinterface). This is
// to allow for unit and integration testing, by giving us the ability to
// mock the behavior of the gcs client.
