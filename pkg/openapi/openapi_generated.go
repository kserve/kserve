			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"ingressGateways": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "IngressGateways is the list of Istio ingress gateways, each in the \"<namespace>/<name>\" format, that external traffic for an InferenceService is accepted on. Listing more than one gateway exposes every InferenceService on all of them, which allows a single InferenceService to be reachable through several ingress paths (for example a public cloud load balancer gateway and a private/VPN-only gateway). When set, it supersedes the deprecated single valued IngressGateway.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"ingressGateway": {
						SchemaProps: spec.SchemaProps{
							Description: "IngressGateway is the single Istio ingress gateway, in the \"<namespace>/<name>\" format, that external traffic for an InferenceService is accepted on.\n\nDeprecated: use IngressGateways instead. It is still honored when IngressGateways is not set.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
