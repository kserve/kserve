		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"authenticationRef": {
						SchemaProps: spec.SchemaProps{
							Description: "authenticationRef is a reference to the authentication information for more information see: https://keda.sh/docs/2.19/scalers/prometheus/#authentication-parameters",
							Default:     map[string]interface{}{},
					...
					"authModes": {
						SchemaProps: spec.SchemaProps{
							Description: "authModes defines the authentication modes for the metrics backend possible values are bearer, basic, tls. for more information see: https://keda.sh/docs/2.19/scalers/prometheus/#authentication-parameters",
							Type:        []string{"string"},
							Format:      "",
						},
					},
