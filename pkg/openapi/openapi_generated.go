...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCachePVCConfig":          schema_pkg_apis_serving_v1alpha1_KernelCachePVCConfig(ref),
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"podsUsing": {
						SchemaProps: spec.SchemaProps{
							Description: "PodsUsing is the number of non-terminating pods on this node currently mounting this cache",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_pkg_apis_serving_v1alpha1_KernelCacheCapture(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCacheCapture captures JIT-compiled kernel caches from running InferenceServices and packages them as OCI images for reuse in other deployments.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_serving_v1alpha1_KernelCacheCaptureSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCacheCaptureSpec defines the desired state of KernelCacheCapture",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"targetImage": {
						SchemaProps: spec.SchemaProps{
							Description: "TargetImage is the OCI image URL where captured cache will be pushed",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"cacheFramework": {
						SchemaProps: spec.SchemaProps{
							Description: "CacheFramework identifies the inference framework running in the ISVC. The controller uses this to locate the framework's default cache directory and stamp the correct cache-type OCI label on the captured image (e.g. vllm → /root/.cache/vllm, gaudi → /home/kserve/.cache/habana). Exactly one of CacheFramework or CachePathOverride must be set.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_serving_v1alpha1_KernelCacheCaptureStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCacheCaptureStatus defines the observed state of KernelCacheCapture",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase indicates current state of the capture",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"imageDigest": {
						SchemaProps: spec.SchemaProps{
							Description: "ImageDigest is the sha256 digest of the captured image",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"capturedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "CapturedAt is the timestamp when capture completed",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"capturedCacheSizeBytes": {
						SchemaProps: spec.SchemaProps{
							Description: "CapturedCacheSizeBytes is the size of the captured cache in bytes",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"kernelCacheRef": {
						SchemaProps: spec.SchemaProps{
							Description: "KernelCacheRef references the auto-created KernelCache",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1alpha1.NamespacedName"),
						},
					},
					"detectedCachePath": {
						SchemaProps: spec.SchemaProps{
							Description: "DetectedCachePath is the resolved cache path used for capture",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"podName": {
						SchemaProps: spec.SchemaProps{
							Description: "PodName is the pod from which cache was captured",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Dependencies: []string{
			"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.NamespacedName", "k8s.io/apimachinery/pkg/apis/meta/v1.Condition", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
...
func schema_pkg_apis_serving_v1alpha1_KernelCachePVCConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCachePVCConfig holds PVC-specific configuration for cache extraction and serving. Only applies when mountType is pvc.\n\nProvisioning modes are mutually exclusive:\n  - Dynamic (storageClassName): the StorageClass provisioner creates the PV automatically.\n  - Static (volumeName): binds to a pre-existing PV by name.\n\nThe storage fields (storageClassName, volumeName, storageSize, accessModes) are immutable after the PVC is provisioned. Changing them after creation conflicts with the existing PVC and has undefined behavior.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"storageClassName": {
						SchemaProps: spec.SchemaProps{
							Description: "StorageClassName names the StorageClass used for dynamic PV provisioning. The StorageClass provisioner creates a PV automatically when the PVC is created. Omit to use the cluster's default StorageClass. Mutually exclusive with volumeName.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"volumeName": {
						SchemaProps: spec.SchemaProps{
							Description: "VolumeName binds the PVC to a pre-existing PV by name (static provisioning). Use when you have pre-created a PV with specific storage type or topology. storageSize is ignored when volumeName is set (capacity is defined on the PV). Mutually exclusive with storageClassName.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"storageSize": {
						SchemaProps: spec.SchemaProps{
							Description: "StorageSize is the storage capacity requested by the PVC. Applies to dynamic provisioning (storageClassName) only; ignored when volumeName is set because the capacity is already defined on the pre-created PV.",
					...
					"accessModes": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "AccessModes for the PVC. When unset, the StorageClass default applies. Multi-node serving requires ReadWriteMany (RWX) so the extraction job and ISVC pods on different nodes can all mount the PVC concurrently; ensure the StorageClass supports RWX before setting it. Single-node deployments can use ReadWriteOnce (RWO).",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"podTemplate": {
						SchemaProps: spec.SchemaProps{
							Description: "PodTemplate customizes the extraction Job pod (resource requests, tolerations, node selector, etc.). Mutable: changes take effect on the next extraction run.",
...
func schema_pkg_apis_serving_v1alpha1_KernelCacheSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"image": {
						SchemaProps: spec.SchemaProps{
							Description: "Image is the OCI image URL containing the kernel cache. Both tags and digests are accepted (e.g. myrepo/cache:v1 or myrepo/cache@sha256:abc123). The webhook resolves tags to digests and pins the resolved digest in status to prevent cache drift.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"mountType": {
						SchemaProps: spec.SchemaProps{
							Description: "MountType specifies how the cache image is delivered to serving containers. pvc: extracts the OCI image into a PersistentVolumeClaim; requires spec.pvc. imageVolume: mounts the OCI image directly without extraction (Kubernetes 1.33+). Immutable after creation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"pvc": {
						SchemaProps: spec.SchemaProps{
							Description: "PVC holds configuration for PVC-based cache delivery. Required when mountType is pvc; must not be set when mountType is imageVolume.",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCachePVCConfig"),
						},
					},
					"imagePullPolicy": {
						SchemaProps: spec.SchemaProps{
							Description: "ImagePullPolicy controls when the cache image is pulled. For pvc mode: governs when the extraction job pulls the image. For imageVolume mode: governs when Kubernetes pulls the image for volume mounting.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"mountPath": {
						SchemaProps: spec.SchemaProps{
							Description: "MountPath in the container filesystem where the cache is mounted. When empty (recommended), auto-computed from OCI image labels to maintain framework compatibility. Override only when automatic detection is insufficient.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Dependencies: []string{
			"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCachePVCConfig"},
	}
}
...
func schema_pkg_apis_serving_v1alpha1_KernelCacheStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"mountType": {
						SchemaProps: spec.SchemaProps{
							Description: "MountType tracks the active mount type (pvc or imageVolume) Reflects the spec.mountType value for observability",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"servingStatus": {
						SchemaProps: spec.SchemaProps{
							Description: "Serving PVC usage (aggregate across all nodes/namespaces)",
		...
		Dependencies: []string{
			"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.CacheCounts", "github.com/kserve/kserve/pkg/apis/serving/v1alpha1.GPUCompatibilitySummary", "github.com/kserve/kserve/pkg/apis/serving/v1alpha1.ServingStatus"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"totalPodsUsing": {
						SchemaProps: spec.SchemaProps{
							Description: "TotalPodsUsing - non-terminating pods using any cache on this node",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
				...
				Required: []string{"cachesInUse", "cachesNotInUse", "cachesError", "totalPodsUsing"},
			},
		},
	}
}
...
func schema_pkg_apis_serving_v1alpha1_ServingStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServingStatus tracks pod usage of this cache across all nodes",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"totalPodsUsing": {
						SchemaProps: spec.SchemaProps{
							Description: "TotalPodsUsing is the total number of non-terminating pods across all nodes that currently have this cache mounted",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
				...
				Required: []string{"totalPodsUsing"},
			},
		},
	}
}
				...
				Properties: map[string]spec.Schema{
					...
					"workloadRef": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("k8s.io/api/core/v1.WorkloadReference"),
						},
					},
				},
				Required: []string{"containers"},
