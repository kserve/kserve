		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"podDisruptionBudget": {
						SchemaProps: spec.SchemaProps{
							Description: "Configures a PodDisruptionBudget for the component to ensure availability during voluntary disruptions such as node drains or cluster upgrades. Only applicable for Standard (raw Kubernetes) deployment mode. Knative mode is not supported (future consideration).",
