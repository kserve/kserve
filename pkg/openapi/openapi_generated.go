			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"annotationsPropagationDisallowList": {
						SchemaProps: spec.SchemaProps{
							Description: "AnnotationsPropagationDisallowList is a list of annotations that are not allowed to be propagated to the knative service",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"labelsPropagationDisallowList": {
						SchemaProps: spec.SchemaProps{
							Description: "LabelsPropagationDisallowList is a list of labels that are not allowed to be propagated to the knative service",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
