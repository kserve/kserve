		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"replicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Configure the number of replicas in the Deployment generated by this ServingRuntime If specified, this overrides the podsPerRuntime configuration value. Note: This configuration is ModelMesh-specific and does not have any effect for non-ModelMesh InferenceServices.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"replicas": {
						SchemaProps: spec.SchemaProps{
							Description: "Replicas specifies the number of replicas that should be deployed. This field is only relevant when using RawDeployment mode, and it sets a hard replica count. If you are using an autoscaler, must leave this field unset and use the MinReplicas and MaxReplicas fields to set the replicas range.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
