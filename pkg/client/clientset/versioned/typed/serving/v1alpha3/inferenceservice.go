...
type InferenceServiceInterface interface {
	Create(*v1alpha3.InferenceService) (*v1alpha3.InferenceService, error)
	Update(*v1alpha3.InferenceService) (*v1alpha3.InferenceService, error)
	UpdateStatus(*v1alpha3.InferenceService) (*v1alpha3.InferenceService, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha3.InferenceService, error)
	List(opts v1.ListOptions) (*v1alpha3.InferenceServiceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha3.InferenceService, err error)
...
func newInferenceServices(c *ServingV1alpha3Client, namespace string) *inferenceServices {
...
func (c *inferenceServices) Get(name string, options v1.GetOptions) (result *v1alpha3.InferenceService, err error) {
	result = &v1alpha3.InferenceService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *inferenceServices) List(opts v1.ListOptions) (result *v1alpha3.InferenceServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.InferenceServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("inferenceservices").
...
func (c *inferenceServices) Create(inferenceService *v1alpha3.InferenceService) (result *v1alpha3.InferenceService, err error) {
	result = &v1alpha3.InferenceService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("inferenceservices").
...
func (c *inferenceServices) Update(inferenceService *v1alpha3.InferenceService) (result *v1alpha3.InferenceService, err error) {
	result = &v1alpha3.InferenceService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("inferenceservices").
...
func (c *inferenceServices) UpdateStatus(inferenceService *v1alpha3.InferenceService) (result *v1alpha3.InferenceService, err error) {
	result = &v1alpha3.InferenceService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("inferenceservices").
...
func (c *inferenceServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha3.InferenceService, err error) {
	result = &v1alpha3.InferenceService{}
