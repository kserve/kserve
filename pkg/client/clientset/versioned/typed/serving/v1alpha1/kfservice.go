...
type KFServiceInterface interface {
	Create(*v1alpha1.KFService) (*v1alpha1.KFService, error)
	Update(*v1alpha1.KFService) (*v1alpha1.KFService, error)
	UpdateStatus(*v1alpha1.KFService) (*v1alpha1.KFService, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.KFService, error)
	List(opts v1.ListOptions) (*v1alpha1.KFServiceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.KFService, err error)
	KFServiceExpansion
}
...
func newKFServices(c *ServingV1alpha1Client, namespace string) *kFServices {
	return &kFServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *kFServices) Get(name string, options v1.GetOptions) (result *v1alpha1.KFService, err error) {
	result = &v1alpha1.KFService{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kfservices").
		Name(name).
...
func (c *kFServices) List(opts v1.ListOptions) (result *v1alpha1.KFServiceList, err error) {
	result = &v1alpha1.KFServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kfservices").
...
func (c *kFServices) Create(kFService *v1alpha1.KFService) (result *v1alpha1.KFService, err error) {
	result = &v1alpha1.KFService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kfservices").
...
func (c *kFServices) Update(kFService *v1alpha1.KFService) (result *v1alpha1.KFService, err error) {
	result = &v1alpha1.KFService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kfservices").
...
func (c *kFServices) UpdateStatus(kFService *v1alpha1.KFService) (result *v1alpha1.KFService, err error) {
	result = &v1alpha1.KFService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kfservices").
...
func (c *kFServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.KFService, err error) {
	result = &v1alpha1.KFService{}
