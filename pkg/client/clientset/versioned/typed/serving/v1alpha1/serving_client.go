...
// ServingV1alpha1Client is used to interact with features provided by the serving.kubeflow.org group.
type ServingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServingV1alpha1Client) KFServices(namespace string) KFServiceInterface {
