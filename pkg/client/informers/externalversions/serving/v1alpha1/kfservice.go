...
import (
	...
	v1alpha1 "github.com/kubeflow/kfserving/pkg/client/listers/serving/v1alpha1"
...
type KFServiceInformer interface {
	...
	Lister() v1alpha1.KFServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServingV1alpha1().KFServices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServingV1alpha1().KFServices(namespace).Watch(options)
			},
		},
		&servingv1alpha1.KFService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kFServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servingv1alpha1.KFService{}, f.defaultInformer)
}

func (f *kFServiceInformer) Lister() v1alpha1.KFServiceLister {
	return v1alpha1.NewKFServiceLister(f.Informer().GetIndexer())
}
