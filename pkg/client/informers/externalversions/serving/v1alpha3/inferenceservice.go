...
type InferenceServiceInformer interface {
	...
	Lister() v1alpha3.InferenceServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServingV1alpha3().InferenceServices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServingV1alpha3().InferenceServices(namespace).Watch(options)
			},
		},
		&servingv1alpha3.InferenceService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferenceServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servingv1alpha3.InferenceService{}, f.defaultInformer)
}

func (f *inferenceServiceInformer) Lister() v1alpha3.InferenceServiceLister {
	return v1alpha3.NewInferenceServiceLister(f.Informer().GetIndexer())
}
