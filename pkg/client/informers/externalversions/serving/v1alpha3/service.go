	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServingV1alpha3().Services(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServingV1alpha3().Services(namespace).Watch(options)
			},
		},
		&servingv1alpha3.Service{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servingv1alpha3.Service{}, f.defaultInformer)
}

func (f *serviceInformer) Lister() v1alpha3.ServiceLister {
	return v1alpha3.NewServiceLister(f.Informer().GetIndexer())
}
