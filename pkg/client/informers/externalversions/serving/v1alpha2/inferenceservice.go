...
type InferenceServiceInformer interface {
	...
	Lister() v1alpha2.InferenceServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServingV1alpha2().InferenceServices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServingV1alpha2().InferenceServices(namespace).Watch(options)
			},
		},
		&servingv1alpha2.InferenceService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferenceServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servingv1alpha2.InferenceService{}, f.defaultInformer)
}

func (f *inferenceServiceInformer) Lister() v1alpha2.InferenceServiceLister {
	return v1alpha2.NewInferenceServiceLister(f.Informer().GetIndexer())
}
