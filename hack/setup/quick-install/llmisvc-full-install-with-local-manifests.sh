...
# Install KServe LLM InferenceService and all related dependencies using kustomize
#
...
main() {
    ...
    echo "=========================================="
    echo "Install KServe LLM InferenceService and all related dependencies using kustomize"
    echo "=========================================="
