...
#
# To regenerate:
#   ./scripts/generate-install-script.py llmisvc-autoscaling-keda-dependency-install.definition
#
# Usage: llmisvc-autoscaling-keda-dependency-install.sh [--reinstall|--uninstall]
...
KEDA_VERSION=2.20.1
OPENTELEMETRY_OPERATOR_VERSION=0.117.0
LWS_VERSION=v0.8.0
