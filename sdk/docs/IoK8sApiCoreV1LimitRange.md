...
**spec** | [**IoK8sApiCoreV1LimitRangeSpec**](IoK8sApiCoreV1LimitRangeSpec.md) | Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status | [optional] 
