...
_TENSORANNOTATION.fields_by_name["quant_parameter_tensor_names"].message_type = (
    _STRINGSTRINGENTRYPROTO
)
...
_TENSORSHAPEPROTO_DIMENSION.fields_by_name["dim_value"].containing_oneof = (
    _TENSORSHAPEPROTO_DIMENSION.oneofs_by_name["value"]
)
_TENSORSHAPEPROTO_DIMENSION.oneofs_by_name["value"].fields.append(
    _TENSORSHAPEPROTO_DIMENSION.fields_by_name["dim_param"]
)
_TENSORSHAPEPROTO_DIMENSION.fields_by_name["dim_param"].containing_oneof = (
    _TENSORSHAPEPROTO_DIMENSION.oneofs_by_name["value"]
)
...
_TYPEPROTO.fields_by_name["sparse_tensor_type"].containing_oneof = (
    _TYPEPROTO.oneofs_by_name["value"]
)
