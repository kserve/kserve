...
import assets.onnx_ml_pb2 as onnx__ml__pb2
...
_PREDICTREQUEST_INPUTSENTRY.fields_by_name["value"].message_type = (
    onnx__ml__pb2._TENSORPROTO
)
...
_PREDICTRESPONSE_OUTPUTSENTRY.fields_by_name["value"].message_type = (
    onnx__ml__pb2._TENSORPROTO
)
