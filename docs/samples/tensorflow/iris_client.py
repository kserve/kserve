...
if __name__ == '__main__':
    ...
    parser.add_argument('--host', help='Knative Host name', default='localhost', type=str)
    parser.add_argument('--port', help='Knative Ingress Port', default=80, type=int)
    ...
    parser.add_argument('--hostname', help='Knative service host name', default='', type=str)
