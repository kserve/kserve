...
```
curl -H "Host: ${MODEL_NAME}-predict.default.svc.cluster.local" http://$CLUSTER_IP/v1/models/$MODEL_NAME:predict -d '{"instances":[[39, 7, 1, 1, 1, 1, 4, 1, 2174, 0, 40, 9]]}'
```
...
```
curl -v -H "Host: ${MODEL_NAME}-explain.default.svc.cluster.local" http://$CLUSTER_IP/v1/models/$MODEL_NAME:explain -d '{"instances":[[39, 7, 1, 1, 1, 1, 4, 1, 2174, 0, 40, 9]]}'
```
