...
`logger` to the instrumentation scope, and retain every other application
field as a log attribute.

Severity numbers use the emitted OpenTelemetry bands: `DEBUG=5`, `INFO=9`,
...
```json
{"timestamp":"2026-09-11T11:34:56.123Z","severity_text":"INFO","severity_number":9,"body":"reconciliation complete","logger":"controller","service.name":"kserve-controller-manager"}
```
