...
| ------------ | ------- |
| [KubeCon 2019: Introducing KFServing: Serverless Model Serving on Kubernetes](https://www.youtube.com/watch?v=saMkA4fIOH8) |Ellis Tarn, Dan Sun|
...
| [KubeflowDojo: Demo - KFServing with Kafka and Kuebflow Pipelines](https://www.youtube.com/watch?v=sVs6gFUddII) |Animesh Singh|
