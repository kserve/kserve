...
manifests: controller-gen yq
	...
	kubectl kustomize https://github.com/kubernetes-sigs/gateway-api-inference-extension//config/crd?ref=$(GIE_VERSION) > config/llmisvc/gateway-inference-extension.yaml
