...
manifests: controller-gen
	...
	$(CONTROLLER_GEN) rbac:roleName=kserve-localmodelnode-manager-role paths=./pkg/controller/v1alpha1/localmodelnode output:rbac:artifacts:config=config/rbac/localmodelnode
