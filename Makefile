...
manifests: controller-gen yq
	...
	# Note: ClusterRoles are already generated by helmify in kserve-proxy-rbac.yaml and kserve-manager-rbac.yaml
	# Note: localmodel roles are already generated by helmify as kserve-localmodel-manager-rbac.yaml
	# and kserve-localmodelnode-agent-rbac.yaml - no need to manually copy them
