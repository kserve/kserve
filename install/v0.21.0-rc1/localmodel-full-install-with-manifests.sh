        ...
        if ! is_positive "$EMBED_MANIFESTS" && [ -z "${KSERVE_OVERLAY_DIR}" ] && ([ -n "${SET_KSERVE_VERSION}" ] || [ -n "${SET_KSERVE_REGISTRY}" ]); then
            ...
            if [ -n "${SET_KSERVE_VERSION}" ]; then
                find "${TARGET_CONFIG_ROOT_DIR}/config" -type f -name "*.yaml" \
                    "${FIND_PRUNE[@]}" \
                    -exec sed -i \
                -e "s/:v0.21.0-rc1/:${SET_KSERVE_VERSION}/g" {} \;
            fi
...
spec:
  ...
  - args:
    ...
    - --http_port=8080
    image: kserve/autogluonserver:v0.21.0-rc1
...
spec:
  ...
  - args:
    ...
    - name: LMCACHE_USE_EXPERIMENTAL
      value: "True"
    image: kserve/huggingfaceserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
...
spec:
  ...
  - args:
    ...
    - name: HF_HUB_CACHE
      value: /tmp
    image: kserve/huggingfaceserver:v0.21.0-rc1-gpu
    livenessProbe:
      exec:
        command:
        - bash
...
spec:
  ...
  - args:
    ...
    - --http_port=8080
    - --nthread=1
    image: kserve/lgbserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
...
spec:
  ...
  - args:
    ...
    - --model_dir=/mnt/models
    - --http_port=8080
    image: kserve/paddleserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
...
spec:
  ...
  - args:
    ...
    - --model_dir=/mnt/models
    - --http_port=8080
    image: kserve/pmmlserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
...
spec:
  ...
  - args:
    ...
    - --nthread=1
    image: kserve/predictiveserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
...
spec:
  ...
  - args:
    ...
    - --model_dir=/mnt/models
    - --http_port=8080
    image: kserve/sklearnserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
...
spec:
  ...
  - args:
    ...
    - name: VLLM_WORKER_MULTIPROC_METHOD
      value: spawn
    image: vllm/vllm-openai:v0.21.0-rc1
    name: kserve-container
    readinessProbe:
      failureThreshold: 3
      httpGet:
...
spec:
  ...
  - args:
    ...
    - --http_port=8080
    - --nthread=1
    image: kserve/xgbserver:v0.21.0-rc1
    name: kserve-container
    resources:
      limits:
        cpu: "1"
      ...
      - command:
        ...
        - name: POD_NAMESPACE
          valueFrom:
            fieldRef:
              fieldPath: metadata.namespace
        image: kserve/kserve-localmodel-controller:v0.21.0-rc1
  ...
  template:
    ...
    spec:
      ...
      - command:
        ...
        image: kserve/kserve-kernelcachenode-agent:v0.21.0-rc1
        imagePullPolicy: IfNotPresent
        livenessProbe:
          httpGet:
            path: /healthz
      ...
      - command:
        ...
        - name: NODE_NAME
          valueFrom:
            fieldRef:
              fieldPath: spec.nodeName
        image: kserve/kserve-localmodelnode-agent:v0.21.0-rc1
        imagePullPolicy: Always
        name: manager
        resources:
          limits:
