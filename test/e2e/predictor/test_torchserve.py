...
async def test_torchserve_kserve():
    service_name = "mnist"
...
@pytest.mark.predictor
@pytest.mark.asyncio(scope="session")
async def test_torchserve_v2_kserve():
    ...
    res = await predict_isvc(service_name, "./data/torchserve_input_v2.json", model_name="mnist", protocol_version="v2")
...
@pytest.mark.predictor
@pytest.mark.asyncio(scope="session")
async def test_torchserve_runtime_kserve():
