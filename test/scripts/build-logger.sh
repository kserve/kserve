...
cd ${GO_DIR}
gcloud builds submit . --tag=${REGISTRY}/${REPO_NAME}/logger:${VERSION} --project=${PROJECT}
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/logger:${VERSION} ${REGISTRY}/${REPO_NAME}/logger:latest --verbosity=info
