...
```console
$ helm install kserve-llmisvc-resources oci://ghcr.io/kserve/charts/kserve-llmisvc-resources --version v0.20.0-rc0
```
...
| kserve.llmisvc.template.renderStrategy | string | `"JSON"` |  |
