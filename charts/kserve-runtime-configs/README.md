...
![Version: v0.18.0-rc0](https://img.shields.io/badge/Version-v0.18.0--rc0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.18.0-rc0](https://img.shields.io/badge/AppVersion-v0.18.0--rc0-informational?style=flat-square)
...
```console
$ helm install kserve-runtime-configs oci://ghcr.io/kserve/charts/kserve-runtime-configs --set kserve.servingruntime.enabled=true --set kserve.llmisvcConfigs.enabled=true --version v0.18.0-rc0
```
...
| kserve.version | string | `"v0.18.0-rc0"` |  |
