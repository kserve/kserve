...
| kserve.agent.tag | string | `"v0.13.1"` |  |
...
| kserve.controller.tag | string | `"v0.13.1"` |  |
...
| kserve.router.tag | string | `"v0.13.1"` |  |
| kserve.servingruntime.art.defaultVersion | string | `"v0.13.1"` |  |
...
| kserve.servingruntime.huggingfaceserver.tag | string | `"v0.13.1"` |  |
| kserve.servingruntime.lgbserver.image | string | `"kserve/lgbserver"` |  |
| kserve.servingruntime.lgbserver.tag | string | `"v0.13.1"` |  |
...
| kserve.servingruntime.paddleserver.tag | string | `"v0.13.1"` |  |
| kserve.servingruntime.pmmlserver.image | string | `"kserve/pmmlserver"` |  |
| kserve.servingruntime.pmmlserver.tag | string | `"v0.13.1"` |  |
| kserve.servingruntime.sklearnserver.image | string | `"kserve/sklearnserver"` |  |
| kserve.servingruntime.sklearnserver.tag | string | `"v0.13.1"` |  |
...
| kserve.servingruntime.xgbserver.tag | string | `"v0.13.1"` |  |
...
| kserve.storage.tag | string | `"v0.13.1"` |  |
| kserve.version | string | `"v0.13.1"` |  |
