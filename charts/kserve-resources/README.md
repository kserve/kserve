...
| kserve.agent.tag | string | `"v0.15.0"` |  |
...
| kserve.controller.tag | string | `"v0.15.0"` | KServe controller contrainer image tag. |
...
| kserve.servingruntime.huggingfaceserver.tag | string | `"v0.15.0"` |  |
...
| kserve.servingruntime.lgbserver.tag | string | `"v0.15.0"` |  |
...
| kserve.servingruntime.paddleserver.tag | string | `"v0.15.0"` |  |
...
| kserve.servingruntime.pmmlserver.tag | string | `"v0.15.0"` |  |
...
| kserve.servingruntime.sklearnserver.tag | string | `"v0.15.0"` |  |
...
| kserve.storage.tag | string | `"v0.15.0"` |  |
| kserve.version | string | `"v0.15.0"` |  |
