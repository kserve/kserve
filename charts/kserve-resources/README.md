...
```console
$ helm install kserve oci://ghcr.io/kserve/charts/kserve --version v0.16.0-rc0
```
...
| kserve.controller.tag | string | `"v0.16.0-rc0"` | KServe controller contrainer image tag. |
...
| kserve.servingruntime.huggingfaceserver.tag | string | `"v0.16.0-rc0"` |  |
...
| kserve.servingruntime.lgbserver.tag | string | `"v0.16.0-rc0"` |  |
...
| kserve.servingruntime.paddleserver.tag | string | `"v0.16.0-rc0"` |  |
...
| kserve.servingruntime.pmmlserver.tag | string | `"v0.16.0-rc0"` |  |
...
| kserve.servingruntime.sklearnserver.tag | string | `"v0.16.0-rc0"` |  |
...
| kserve.servingruntime.xgbserver.tag | string | `"v0.16.0-rc0"` |  |
