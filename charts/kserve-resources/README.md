...
![Version: v0.14.0](https://img.shields.io/badge/Version-v0.14.0-informational?style=flat-square)
...
```console
$ helm install kserve oci://ghcr.io/kserve/charts/kserve --version v0.14.0
```
...
| kserve.controller.gateway.ingressGateway.enableGatewayApi | bool | `false` | ingressGateway specifies the gateway which handles the network traffic from outside the cluster. |
