...
func main() {
	...
	otelFound, otelCheckErr := utils.IsCrdAvailable(cfg, otelv1alpha1.GroupVersion.String(), constants.OpenTelemetryCollector)
	if otelCheckErr != nil {
	...
	if otelFound {
		...
		if err := otelv1alpha1.AddToScheme(mgr.GetScheme()); err != nil {
